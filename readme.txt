...
scolari_david_output.tex is located in the output folder. It will run after tables and figures have been built by runme.do and contingent do file. 

master.dta is in the data folder